...
const Product = () => {
  return (
    <article className="product">
      <img className="product__image" src="https://fakestoreapi.com/img/81fPKd-2AYL._AC_SL1500_.jpg" width="100%" height="auto" alt="Product image" />
      <h3 className="product__title">Fjallraven - Foldsack No. 1 Backpack, Fits 15 Laptops</h3>
      <p className="product__price">$109.95</p>
      <p className="product__description">Your perfect pack for everyday use and walks in the forest. Stash your laptop (up to 15 inches) in the padded sleeve, your everyday</p>
